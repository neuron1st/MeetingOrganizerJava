...
<body>
    ...
    <p>Like Count: ${meeting.likeCount}</p>
        <form action="<%= request.getContextPath() + "/meetings/createMeetingLike" %>" method="post">
            <input type="hidden" name="meetingId" value="${meeting.meetingId}" />
            <button type="submit">+</button>
        </form>
        <form action="<%= request.getContextPath() + "/meetings/deleteMeetingLike" %>" method="post">
            <input type="hidden" name="meetingId" value="${meeting.meetingId}" />
            <button type="submit">-</button>
        </form>
    <p>Participant Count: ${meeting.participantCount}</p>
        <form action="<%= request.getContextPath() + "/meetings/createParticipant" %>" method="post">
            <input type="hidden" name="meetingId" value="${meeting.meetingId}" />
            <button type="submit">+</button>
        </form>
        <form action="<%= request.getContextPath() + "/meetings/deleteParticipant" %>" method="post">
            <input type="hidden" name="meetingId" value="${meeting.meetingId}" />
            <button type="submit">-</button>
        </form>
    ...
    <ul>
        <c:forEach var="comment" items="${comments}">
            <li>
                ...
                <form action="<%= request.getContextPath() + "/meetings/createCommentLike" %>" method="post">
